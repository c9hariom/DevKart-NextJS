...
const Checkout = ({cart , subTotal}) => {
  ...
  return (
    ...
    <a href="#" className="text-2xl font-bold text-gray-800">Delivery Details</a>
  ...
  return (
    <div key={keys} className="flex flex-row items-center rounded-lg bg-white mb-2">
      <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src="/tshirt.jpg" alt="" />
      <div className="flex flex-col flex-grow p-2">
        ...
        <div className="flex justify-between items-center mb-2">
        <span className="font-semibold">${cart[keys].price} X {cart[keys].qty} </span>
          <span className="font-semibold">${cart[keys].price * cart[keys].qty}</span>
        </div>
      </div>
    </div>
  );
      ...
      <div className="">
        ...
        <div className="mt-6 border-t border-b py-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <p className="font-semibold text-gray-900">${Object.keys(cart).length===0?0:8}</p>
          </div>
        </div>
