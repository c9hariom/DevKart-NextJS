...
export default function Home() {
  ...
  <Image src="/coder.png" alt="pixabay/coder.png" width={1920} height={100} />
</div>

      <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">&lt;/devkart&gt;</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the code if you love the code: Unleash your passion with every stitch, let your attire speak the language of innovation.</p>
    </div>
