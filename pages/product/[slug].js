          ...
          <div className='lg:w-4/5 mx-10 flex flex-wrap'>
            ...
            <div className='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
              ...
              <div className='flex md:flex-nowrap flex-wrap  items-end md:justify-start'>
                ...
                <button
                  className='inline-flex text-white bg-pink-500 border-0 py-2 px-10 focus:outline-none hover:bg-red-600 rounded'
                  onClick={checkPin}
                >
                  Check
                </button>
              ...
              <p hidden={badPin} className='mt-2 text-red-500'>
                Please enter 6 digit pincode
              </p>

              <p
                className={`mt-2 ${
                  pinStatus.status ? 'text-green-500' : 'text-red-500'
                }`}
              >
                {pinStatus.msg}
              </p>
