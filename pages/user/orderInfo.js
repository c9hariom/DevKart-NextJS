...
const OrderInfo = ({ cart, userAuth, orderId, clearCart }) => {
                ...
                <thead>
                  <tr>
                    {orderDetails.status === 'paid' && (
                      <th
                        colSpan={2}
                        className='px-6 py-3 ml-auto bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider'
                      >
